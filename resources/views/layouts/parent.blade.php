...
<body class="dark-edition">
    ...
    <!-- Chartist JS -->
    <script src="{{URL::asset('adminpanel/js/plugins/chartist.min.js')}}"></script>
    <!--  Notifications Plugin    -->
    <script src="{{URL::asset('adminpanel/js/plugins/bootstrap-notify.js')}}"></script>
    <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="{{URL::asset('adminpanel/js/material-dashboard.js?')}}"></script>
    <!-- Material Dashboard DEMO methods, don't include it in your project! -->
    <script src="{{URL::asset('adminpanel/demo/demo.js')}}"></script>
    <script>
